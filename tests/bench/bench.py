...
XL_FUNCS = 992          # многомодульная программа (предел языка — 2048)
...
def bench_stress(quick: bool):
    ...
    cases = [
        ...
        ("функции: 2048 (на пределе)", genprog.stress_funcs(2048),
         "check", True),
        ("функции: 2049 (за пределом)", genprog.stress_funcs(2049),
         "check", False),
