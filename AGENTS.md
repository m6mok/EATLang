...
3. **Определение готовности**:
   ...
   verify_trapcodes verify_sig verify_selfhost_verify
...
selfhost/     компилятор на EATLang: Tok, Lexer, Ast, Parser, Check,
              Verify, Ir, *Main; Rt.eat — рантайм, первый модуль
              каждой программы
